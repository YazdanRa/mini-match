...
- `result-lowest-unique.png` — approved result and score treatment

Approved flow: create or join a table, lock any non-negative integer in the lobby, then reveal after everyone locks. Duplicate picks are ineligible; the lowest number chosen exactly once wins. This rule supersedes contradictory copy in a sketch.
